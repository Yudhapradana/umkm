            ...
            <div class="modal-content">
                ...
                <div class="modal-body">                          
                    ...
                    <div class="form-group col-lg-12">
                        <font>Anda ingin menghapus <b><font id="nama_teknologi_del"></font></b></font>
...
<script type="text/javascript">
    $(document).ready(function(){
                ...
                function showTeknologi() {
                    $.ajax({
                        type  : 'POST',
                        url   : '<?php echo base_url()?>index.php/PemilikEkraf/getDataTeknologiEkraf',
                        async : false,
                        dataType : 'json',
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo site_url(); ?>/PemilikEkraf/newTeknologiEkraf",
                    dataType : "JSON",
                    data : {
                        id_teknologi:nte,
                    },
                ...
                $('#formupdate').submit(function(e){
                    ...
                    $.ajax({
                        type : "POST",
                        url  : "<?php echo site_url(); ?>/PemilikEkraf/updateEkrafTeknologi",
                        dataType : "JSON",
                        data : { 
                            id:up_id,
                            // nama:up_namae,
            ...
            $('#formdelete').submit(function(e){
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo site_url(); ?>/PemilikEkraf/deleteEkrafTeknologi",
                    dataType : "JSON",
                    data : {
                        id:id,
                    },
