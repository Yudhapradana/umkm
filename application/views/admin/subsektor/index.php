                    ...
                    $.ajax({
                        ...
                        success : function(data){
                            ...
                            for(i=0; i<data.length; i++){
                                ...
                                '<td>'+ '<a href="javascript:void(0);" class="btn btn-warning btn-sm item_edit" data-id="'+data[i].id_subsektor+'" data-nama="'+data[i].nama_subsektor+'" > <span class="fa fa-edit"></span> </a>'+ 
                                '     '+
                                '<a href="javascript:void(0);" class="btn btn-danger btn-sm item_delete" data-id="'+data[i].id_subsektor+'" data-nama="'+data[i].nama_subsektor+'"> <span class="fa fa-trash"></span> </a>'+
                                '</td>'+
                                '</tr>';
                            }
