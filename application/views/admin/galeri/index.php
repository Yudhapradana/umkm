        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function showGaleri() {
                    $.ajax({
                        type  : 'POST',
                        url   : '<?php echo base_url()?>index.php/Ekraf/getEkraf',
                        async : false,
                        dataType : 'json',
                        success : function(data){
                            ...
                            for(i=0; i<data.length; i++){
                                ...
                                '<td>'+ii+'</td>'+
                                '<td>'+data[i].nama+'</td>'+
                                '<td>'+ '<a href="javascript:void(0);" class="btn btn-warning btn-sm galeri" data-id="'+data[i].id_ekraf+'" data-nama="'+data[i].nama+'" > <span class="fa fa-picture-o"></span> </a>'+ 
                                '     '+
                                '</td>'+
                                '</tr>';
                            }
