        ...
        <script type="text/javascript">
            $(document).ready(function(){
                ...
                function showTeknologi() {
                    $.ajax({
                        type  : 'POST',
                        url   : '<?php echo base_url()?>index.php/Operator/getDataTeknologiEkraf',
                        async : false,
                        dataType : 'json',
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo site_url(); ?>/Operator/newTeknologiEkraf",
                    dataType : "JSON",
                    data : {
                        nama:ne,
                        id_teknologi:nte,
                ...
                $('#formupdate').submit(function(e){
                    ...
                    $.ajax({
                        type : "POST",
                        url  : "<?php echo site_url(); ?>/Operator/updateEkrafTeknologi",
                        dataType : "JSON",
                        data : { 
                            id:up_id,
                            nama:up_namae,
            ...
            $('#formdelete').submit(function(e){
                ...
                $.ajax({
                    type : "POST",
                    url  : "<?php echo site_url(); ?>/Operator/deleteEkrafTeknologi",
                    dataType : "JSON",
                    data : {
                        id:id,
                    },
